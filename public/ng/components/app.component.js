System.register(['angular2/core', 'angular2/http', './language.component', 'rxjs/add/operator/map'], function(exports_1) {
    "use strict";
    ...
    var core_1, http_1, language_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [language_component_1.Language],
                        inputs: ['lng'],
                        template: "\n    <language></language>\n    <h1>LNG={{ lng }}</h1>\n  "
                    }), 
